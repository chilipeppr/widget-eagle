...
| chilipeppr.load() URL | http://raw.githubusercontent.com/ameennihad/widget-eagle/staging/auto-generated-widget.html |
| Edit URL              | http://ide.c9.io/ameennihad/widget-eagle-staging |
| Github URL            | http://github.com/ameennihad/widget-eagle |
| Test URL              | https://preview.c9users.io/ameennihad/widget-eagle-staging/widget.html |
...
chilipeppr.load(
  "#myDivWidgetEagle",
  "http://raw.githubusercontent.com/ameennihad/widget-eagle/staging/auto-generated-widget.html",
  function() {
...
The table below shows, in order, the methods and properties inside the widget/element.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-widget-eagle"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Widget / Eagle BRD v5.1"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"This widget lets you drag in an Eagle PCB \".brd\" file to mill."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/ameennihad/widget-eagle/staging/auto-generated-widget.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/ameennihad/widget-eagle-staging"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/ameennihad/widget-eagle"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://widget-eagle-staging-ameennihad.c9users.io/widget.html"</td></tr><tr valign="top"><td>publish</td><td>object</td><td>Please see docs above.<br><br>Define the publish signals that this widget/element owns or defines so that
