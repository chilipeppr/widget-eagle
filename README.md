...
## ChiliPeppr Widget / Eagle BRD v5.7
  ...
  function() {
    ...
    cprequire(
      ...
      function(myObjWidgetEagle) {
        ...
        console.log("Widget / Eagle BRD v5.7 just got loaded.", myObjWidgetEagle);
