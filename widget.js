    ...
    addGcodeCallback(1500, myOwnGcode ); 
        ...
        */
        ...
        exportGcodeDimensions:function(){
            ...
            //console.log("Ameen - original clipperDimension", this.clipperDimension);
        ...
        getDimensionWires: function () {
            ...
            for(i = 0; i < wires.length-1; i++){
                //console.log("Ameen", "Testing Wire:", i, JSON.stringify(wires[i]));
                var j = i + 1;
                var h = i + 1;
            ...
            //V5.3D201701XX Following code dded to support slots
            this.dimensionInfo = [];
            var diStartIndex = 0;
            ...
            //console.log("Ameen", "Dimension Info: \\n", JSON.stringify(this.dimensionInfo));
