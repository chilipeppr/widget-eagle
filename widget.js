...
cprequire_test(["inline:com-chilipeppr-widget-eagle"], function (ew) {
    ...
    // test before and after render
    chilipeppr.subscribe("/" + ew.id + '/beforeParse', this, function(eagleWidget) {
        console.log("publish test. got the /beforeParse signal. eagleWidget:", eagleWidget);
    });
    chilipeppr.subscribe("/" + ew.id + '/afterParse', this, function(eagleWidget) {
        console.log("publish test. got the /afterParse signal. eagleWidget:", eagleWidget);
    });
...
onAddGcode : function(addGcodeCallback, gcodeParts, eagleWidget, helpDesc){ 
    ...
    addGcodeCallback(1500, myOwnGcode ); 
        ...
        onDraw3dReady: function () {
            ...
            chilipeppr.publish("/" + this.id + '/beforeParse', this);
            ...
            // all of our draw3dxxx functions which means all our three.js objects
            // and clipper objects are generated.
            chilipeppr.publish("/" + this.id + '/afterParse', this);
