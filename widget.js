...
cprequire_test(["inline:com-chilipeppr-widget-eagle"], function (ew) {
    ...
    chilipeppr.subscribe("/" + ew.id + '/beforeRender', this, function(eagleWidget) {
        console.log("got the /beforeRender signal. eagleWidget:", eagleWidget);
    });
    chilipeppr.subscribe("/" + ew.id + '/afterRender', this, function(eagleWidget) {
        console.log("got the /afterRender signal. eagleWidget:", eagleWidget);
    });
...
onAddGcode : function(addGcodeCallback, gcodeParts, eagleWidget, helpDesc){ 
    ...
    addGcodeCallback(1500, myOwnGcode ); 
            ...
            `,
            '/beforeRender' : `This widget fires a signal before the rendering of the Eagle BRD. 
                ...
                `,
            '/afterRender' : `This widget fires a signal after the rendering of the Eagle BRD. 
        ...
        onRefresh: function(event, callback) {
            ...
            chilipeppr.publish('/' + this.id + '/beforeRender', this);
        ...
        onRefresh2nd: function(event, callback) {
            ...
            */
            ...
            chilipeppr.publish('/' + this.id + '/afterRender', this);
